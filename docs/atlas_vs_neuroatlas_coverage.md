...
(ds005178), updated again 2026-07-13 after CHB-MIT + Siena + ISRUC.*
...
| **NeuroTechX Atlas** (non-MOABB): TDBRAIN, LEMON, HBN, Alljoined, TUSZ, SeizeIT2, Helsinki, Sleep-EDF, HMC, N170 (ds002718), ERN (ds004883), P3-aud (ds003061), P3-vis (ds006018), M3CV, DOD-H, DOD-O, Ear-EEG, CHB-MIT, Siena, ISRUC | **20** | this session + `~/dev/meeg-brain-age-benchmark-paper` |
| **Total distinct datasets processed** | **131** | |
| **NeuroAtlas** | 42 | arXiv:2605.14698 |

**We exceed NeuroAtlas's dataset count by 89 (131 vs 42, ~3.1×).**
...
- **Sleep cohorts**: MASS, DCSM — Sleep-EDF + HMC + Dreem DOD-H/DOD-O +
  **ISRUC** now done (5 of ~7 named NeuroAtlas sleep sets); MASS needs an
  application. DCSM is fully downloaded and extracted (edf+hypnogram only,
  skipping redundant .h5 duplicates — 255/255 subjects on disk), loader
  pending. Ear-EEG (ds005178) is an *additional* sleep dataset beyond
...
None of these are required to keep the dataset-count lead (131 vs 42 already
